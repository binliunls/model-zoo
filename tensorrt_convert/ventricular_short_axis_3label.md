...
DEBUG: [Torch-TensorRT TorchScript Conversion Context] - graph(%1 : int[],
      %3 : Tensor):
  %5 : int = prim::Constant[value=2]() # /opt/conda/lib/python3.8/site-packages/torch/nn/modules/conv.py:459:45
  %self.model.1.dim.1 : int = prim::Constant[value=1]()
  %8 : bool = prim::Constant[value=1]()
  %15 : NoneType = prim::Constant() # /opt/conda/lib/python3.8/site-packages/torch/nn/modules/instancenorm.py:263:4
  %16 : float = prim::Constant[value=0.10000000000000001]() # /opt/conda/lib/python3.8/site-packages/torch/nn/modules/instancenorm.py:36:59
  %17 : float = prim::Constant[value=1.0000000000000001e-05]() # /opt/conda/lib/python3.8/site-packages/torch/nn/modules/instancenorm.py:36:74
  %self.model.0.conv.unit0.adn.A.weight.1 : Float(1, strides=[1], requires_grad=0, device=cuda:0) = prim::Constant[value={0.102285}]()
  %self.model.0.conv.unit1.conv.weight.1 : Float(16, 16, 3, 3, strides=[144, 9, 3, 1], requires_grad=0, device=cuda:0) = prim::Constant[value=<Tensor>]()
  %self.model.0.conv.unit1.conv.bias.1 : Float(16, strides=[1], requires_grad=0, device=cuda:0) = prim::Constant[value=<Tensor>]()
  %23 : int[] = prim::Constant[value=[1, 1]]()
  %24 : bool = prim::Constant[value=0]()
  %25 : int[] = prim::Constant[value=[0, 0]]()
  ...
  %4 : int = aten::__range_length(%5, %0, %self.model.1.dim.1) # /opt/conda/lib/python3.8/site-packages/torch/nn/functional.py:2454:4
  %size_prods.48 : int = prim::Loop(%4, %8, %self.model.1.dim.1) # /opt/conda/lib/python3.8/site-packages/torch/nn/functional.py:2454:4
    block0(%9 : int, %size_prods.50 : int):
      %i.16 : int = aten::__derive_index(%9, %5, %self.model.1.dim.1) # /opt/conda/lib/python3.8/site-packages/torch/nn/functional.py:2454:4
      %12 : int = aten::__getitem__(%2, %i.16) # /opt/conda/lib/python3.8/site-packages/torch/nn/functional.py:2455:22
      %size_prods.52 : int = aten::mul(%size_prods.50, %12) # /opt/conda/lib/python3.8/site-packages/torch/nn/functional.py:2455:8
      -> (%8, %size_prods.52)
  %14 : Tensor = aten::instance_norm(%3, %15, %15, %15, %15, %8, %16, %17, %8) # /opt/conda/lib/python3.8/site-packages/torch/nn/functional.py:2491:11
  %input.50 : Tensor = aten::prelu(%14, %self.model.0.conv.unit0.adn.A.weight.1) # /opt/conda/lib/python3.8/site-packages/torch/nn/modules/activation.py:1230:15
  %20 : Tensor = aten::_convolution(%input.50, %self.model.0.conv.unit1.conv.weight.1, %self.model.0.conv.unit1.conv.bias.1, %23, %23, %23, %24, %25, %self.model.1.dim.1, %24, %24, %24, %24)
  return (%20)

DEBUG: [Torch-TensorRT TorchScript Conversion Context] - Input Dimension Specs: {
    3 : Input(shape: [1, 16, 128, 128], dtype: Float32, format: NCHW\Contiguous\Linear),}
INFO: [Torch-TensorRT TorchScript Conversion Context] - Adding Input 3 (named: input_0): Input(shape: [1, 16, 128, 128], dtype: Float32, format: NCHW\Contiguous\Linear) in engine (conversion.AddInputs)
DEBUG: [Torch-TensorRT TorchScript Conversion Context] - Evaluating %5 : int = prim::Constant[value=2]() # /opt/conda/lib/python3.8/site-packages/torch/nn/modules/conv.py:459:45
DEBUG: [Torch-TensorRT TorchScript Conversion Context] - Found the value to be: 2
DEBUG: [Torch-TensorRT TorchScript Conversion Context] - Evaluating %self.model.1.dim.1 : int = prim::Constant[value=1]()
DEBUG: [Torch-TensorRT TorchScript Conversion Context] - Found the value to be: 1
DEBUG: [Torch-TensorRT TorchScript Conversion Context] - Evaluating %8 : bool = prim::Constant[value=1]()
DEBUG: [Torch-TensorRT TorchScript Conversion Context] - Found the value to be: True
DEBUG: [Torch-TensorRT TorchScript Conversion Context] - Evaluating %15 : NoneType = prim::Constant() # /opt/conda/lib/python3.8/site-packages/torch/nn/modules/instancenorm.py:263:4
DEBUG: [Torch-TensorRT TorchScript Conversion Context] - Found the value to be: None
DEBUG: [Torch-TensorRT TorchScript Conversion Context] - Evaluating %16 : float = prim::Constant[value=0.10000000000000001]() # /opt/conda/lib/python3.8/site-packages/torch/nn/modules/instancenorm.py:36:59
DEBUG: [Torch-TensorRT TorchScript Conversion Context] - Found the value to be: 0.10000000000000001
DEBUG: [Torch-TensorRT TorchScript Conversion Context] - Evaluating %17 : float = prim::Constant[value=1.0000000000000001e-05]() # /opt/conda/lib/python3.8/site-packages/torch/nn/modules/instancenorm.py:36:74
DEBUG: [Torch-TensorRT TorchScript Conversion Context] - Found the value to be: 1.0000000000000001e-05
DEBUG: [Torch-TensorRT TorchScript Conversion Context] - Evaluating %self.model.0.conv.unit0.adn.A.weight.1 : Float(1, strides=[1], requires_grad=0, device=cuda:0) = prim::Constant[value={0.102285}]()
DEBUG: [Torch-TensorRT TorchScript Conversion Context] - Found the value to be a tensor (shape [1])
DEBUG: [Torch-TensorRT TorchScript Conversion Context] - Evaluating %self.model.0.conv.unit1.conv.weight.1 : Float(16, 16, 3, 3, strides=[144, 9, 3, 1], requires_grad=0, device=cuda:0) = prim::Constant[value=<Tensor>]()
DEBUG: [Torch-TensorRT TorchScript Conversion Context] - Found the value to be a tensor (shape [16, 16, 3, 3])
DEBUG: [Torch-TensorRT TorchScript Conversion Context] - Evaluating %self.model.0.conv.unit1.conv.bias.1 : Float(16, strides=[1], requires_grad=0, device=cuda:0) = prim::Constant[value=<Tensor>]()
DEBUG: [Torch-TensorRT TorchScript Conversion Context] - Found the value to be a tensor (shape [16])
...
> Build information about Torch-TensorRT can be found by turning on debug messages
 ...
 - Any other relevant information:bundle_version:0.3.1
